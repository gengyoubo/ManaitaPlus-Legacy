package sen.manaita_plus_legacy.loottable;
...
public class ManaitaPlusLegacyLootTable extends LootTableProvider {
    public ManaitaPlusLegacyLootTable(PackOutput packOutput) {
            ...
            p_249643_.accept(
                    ...
                    LootTable.lootTable()
                            .withPool(LootPool.lootPool()
                                    ...
                                    .add(LootItem.lootTableItem(ManaitaPlusLegacyItemCore.ManaitaBow.get())
                                            .setWeight(1)

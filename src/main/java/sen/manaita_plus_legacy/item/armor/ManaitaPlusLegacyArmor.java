package sen.manaita_plus_legacy.item.armor;
...
public class ManaitaPlusLegacyArmor extends ArmorItem {
    protected ManaitaPlusLegacyArmor(Type type) {
        super(new ManaitaArmorMaterial(), type, new Item.Properties().fireResistant());
    }

    @Override
    public void appendHoverText(@NotNull ItemStack stack, @Nullable Level level, List<Component> tooltip, @NotNull TooltipFlag flag) {
        tooltip.add(Component.literal(ManaitaPlusText.manaita_infinity.formatting(I18n.get("info.armor"))));
    }
    ...
    public static class Helmet extends ManaitaPlusLegacyArmor implements IManaitaPlusLegacyKey {
        ...
        public void appendHoverText(@NotNull ItemStack stack, @Nullable Level level, List<Component> tooltip, @NotNull TooltipFlag flag) {
            tooltip.add(Component.literal(
                    ManaitaPlusText.manaita_mode.formatting(
        ...
        public void onManaitaKeyPressOnClient(ItemStack itemStack, Player player) {
            ...
            ManaitaPlusUtils.chat(player, Component.literal(
                    ManaitaPlusText.manaita_mode.formatting(String.format("[%s] %s: %s",
    ...
    public static class Boots extends ManaitaPlusLegacyArmor implements IManaitaPlusLegacyKey {
        ...
        public void onManaitaKeyPressOnClient(ItemStack itemStack, Player player) {
            onManaitaKeyPress(itemStack);
            ManaitaPlusUtils.chat(player, Component.literal(
                    ManaitaPlusText.manaita_mode.formatting(String.format("[%s] %s: %d",

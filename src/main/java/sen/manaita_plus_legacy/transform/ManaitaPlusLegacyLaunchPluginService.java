package sen.manaita_plus_legacy.transform;
...
public class ManaitaPlusLegacyLaunchPluginService implements ILaunchPluginService {
    ...
    private static final String EVENT_UTIL_OWNER = "sen/manaita_plus_legacy/util/EventUtil";
    ...
    private static InsnList buildItemCooldownGuard() {
        ...
        insnNodes.add(new TypeInsnNode(Opcodes.INSTANCEOF, "sen/manaita_plus_legacy/item/data/IManaitaPlusLegacyKey"));
        insnNodes.add(new JumpInsnNode(Opcodes.IFEQ, label));
        insnNodes.add(new VarInsnNode(Opcodes.ALOAD, 1));
        insnNodes.add(new TypeInsnNode(Opcodes.INSTANCEOF, "sen/manaita_plus_legacy/item/armor/ManaitaPlusLegacyArmor"));
        insnNodes.add(new JumpInsnNode(Opcodes.IFEQ, label));
    ...
    private static InsnList buildEntityDataDefineInsn() {
        ...
        insnNodes.add(new FieldInsnNode(Opcodes.GETSTATIC, "sen/manaita_plus_legacy/util/ManaitaPlusLegacyEntityData", "Type", "Lnet/minecraft/network/syncher/EntityDataAccessor;"));

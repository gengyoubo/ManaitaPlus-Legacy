...
public class MPItemCore {
    ...
    public static final RegistryObject<Item> ManaitaPaxel = ITEMS.register("manaita_paxel", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> ManaitaFurnacePortable = ITEMS.register("manaita_furnace_portable", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> ManaitaBrewingPortable = ITEMS.register("manaita_brewing_portable", () -> new Item(new Item.Properties()));

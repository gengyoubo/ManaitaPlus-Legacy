package sen.manaita_plus_legacy.network.server;
...
import sen.manaita_plus_legacy.network.ClientPacketHandlers;
...
public class DestroyBlockPacket {
    ...
    public void handler(Supplier<NetworkEvent.Context> ctx) {
        ctx.get().enqueueWork(() -> {
            ...
            DistExecutor.unsafeRunWhenOn(Dist.CLIENT, () -> () -> ClientPacketHandlers.handleDestroyBlock(this));
        });

        ...
        do {
            for (Method method : superClass.getMethods()) {
                ...
                if (!Modifier.isStatic(modifiers) && !Modifier.isInterface(modifiers) && (Modifier.isPublic(modifiers) || Modifier.isProtected(modifiers))) {
                    ...
                    mv.visitCode();
                    mv.visitFieldInsn(GETSTATIC, "sen/manaita_plus_legacy/util/ManaitaEntityList", "death", "Lsen/manaita_plus/util/ManaitaEntityList;");
                    mv.visitVarInsn(ALOAD, 0);
                    mv.visitMethodInsn(INVOKEVIRTUAL, "sen/manaita_plus_legacy/util/ManaitaEntityList", "accept", "(Lnet/minecraft/world/entity/Entity;)Z", false);

...
import static sen.manaita_plus_legacy.core.ManaitaPlusLegacyBlockCore.HookBlock;
...
public class ManaitaPlusHookBlockItem extends BlockItem {
    ...
    private BlockState updateBlockStateFromTag(BlockPos pos, Level level, ItemStack p_40605_, BlockState p_40606_) {
        if (p_40606_.getBlock() instanceof ManaitaPlusHookBlock && p_40605_.getTag() != null) {
            BlockState manaitaType = p_40606_.setValue(ManaitaPlusLegacyBlockData.TYPES, p_40605_.getTag().getInt(ManaitaPlusLegacyNBTData.ItemType));

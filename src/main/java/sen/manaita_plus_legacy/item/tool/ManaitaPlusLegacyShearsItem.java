...
public class ManaitaPlusLegacyShearsItem extends ShearsItem implements IManaitaPlusLegacyKey, IManaitaPlusLegacyDestroy, IManaitaPlusLegacyDoubling {
    public ManaitaPlusLegacyShearsItem() {
    ...
    public void setRange(ItemStack itemStack, int range, Player player) {
        ...
        if (player != null) {
            ManaitaPlusUtils.chat(player, Component.literal(ManaitaPlusText.manaita_mode.formatting("[" + I18n.get("item.manaita_plus_legacy.manaita_shears") + "] " + I18n.get("mode.range.name") + ": " + range + "x" + range + "x" + range)));
        }
    }
    ...
    public void onManaitaKeyPressOnClient(ItemStack itemStack, Player player) {
        ...
        ManaitaPlusUtils.chat(player, Component.literal(ManaitaPlusText.manaita_mode.formatting(String.format("[%s] %s: %s", I18n.get("item.manaita_plus_legacy.manaita_shears"), I18n.get("mode.doubling"), (doubling ? I18n.get("info.on") : I18n.get("info.off"))))));
    }

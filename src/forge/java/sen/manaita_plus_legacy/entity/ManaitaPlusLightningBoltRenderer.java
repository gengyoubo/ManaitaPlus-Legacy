...
public class ManaitaPlusLightningBoltRenderer extends EntityRenderer<ManaitaPlusLegacyLightningBolt> {
    ...
    public void render(ManaitaPlusLegacyLightningBolt p_115266_, float p_115267_, float p_115268_, @NotNull PoseStack p_115269_, @NotNull MultiBufferSource p_115270_, int p_115271_) {
    ...
    public @NotNull ResourceLocation getTextureLocation(@NotNull ManaitaPlusLegacyLightningBolt p_115264_) {

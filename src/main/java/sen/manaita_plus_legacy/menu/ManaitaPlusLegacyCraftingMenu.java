...
public class ManaitaPlusLegacyCraftingMenu extends RecipeBookMenu<CraftingContainer> {
    ...
    public ManaitaPlusLegacyCraftingMenu(int p_39353_, Inventory p_39354_, FriendlyByteBuf extraData) {
        this(p_39353_, p_39354_, ContainerLevelAccess.NULL);
    }

    public ManaitaPlusLegacyCraftingMenu(int p_39353_, Inventory p_39354_, Level level) {
        this(p_39353_, p_39354_, ContainerLevelAccess.create(level, BlockPos.ZERO));
        stillValid = true;
    }

    public ManaitaPlusLegacyCraftingMenu(int p_39356_, Inventory p_39357_, ContainerLevelAccess p_39358_) {
        super(ManaitaPlusLegacyMenuCore.CraftingManaita.get(), p_39356_);
        ...
        if (!p_150548_.isClientSide) {
            ...
            if (optional.isPresent()) {
                ...
                if (itemstack1.isItemEnabled(p_150548_.enabledFeatures())) {
                    ...
                    itemstack.setCount(itemstack.getCount() * ManaitaPlusLegacyConfig.crafting_doubling_value);
                }
            }
    ...
    public boolean stillValid(@NotNull Player p_39368_) {
        ...
        return stillValid(this.access, p_39368_, ManaitaPlusLegacyBlockCore.CraftingBlock.get());
    }

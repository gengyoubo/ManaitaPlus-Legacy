...
import github.com.gengyoubo.core.MPGRecipeSerializerCore;
...
public class MPGNBTCraftingRecipe implements CraftingRecipe, IShapedRecipe<CraftingContainer> {
    ...
    public MPGNBTCraftingRecipe(ResourceLocation p_273203_, String p_272759_, CraftingBookCategory p_273506_, int p_272952_, int p_272920_, NonNullList<Ingredient> p_273650_, ItemStack p_272852_, boolean p_273122_) {
        this.id = p_273203_;
...
//    public MPGNBTCraftingRecipe(ResourceLocation p_250963_, String p_250221_, CraftingBookCategory p_250716_, int p_251480_, int p_251980_, NonNullList<Ingredient> p_252150_, ItemStack p_248581_) {
...
// --注释掉检查 STOP (2026/4/24 23:35)
    ...
    public static class Serializer implements RecipeSerializer<MPGNBTCraftingRecipe> {
        public @NotNull MPGNBTCraftingRecipe fromJson(@NotNull ResourceLocation p_44236_, @NotNull JsonObject p_44237_) {
            ...
            String[] astring = MPGNBTCraftingRecipe.shrink(MPGNBTCraftingRecipe.patternFromJson(GsonHelper.getAsJsonArray(p_44237_, "pattern")));
            int i = astring[0].length();
            int j = astring.length;
            NonNullList<Ingredient> nonnulllist = MPGNBTCraftingRecipe.dissolvePattern(astring, map, i, j);
            ...
            return new MPGNBTCraftingRecipe(p_44236_, s, craftingbookcategory, i, j, nonnulllist, itemstack, flag);
        }



        public MPGNBTCraftingRecipe fromNetwork(@NotNull ResourceLocation p_44239_, FriendlyByteBuf p_44240_) {
            ...
            return new MPGNBTCraftingRecipe(p_44239_, s, craftingbookcategory, i, j, nonnulllist, itemstack, flag);
        }

        public void toNetwork(FriendlyByteBuf p_44227_, MPGNBTCraftingRecipe p_44228_) {
        ...
        public static final MPGNBTIngredient EMPTY = new MPGNBTIngredient(Stream.empty());
        public static MPGNBTIngredient fromValues(Stream<? extends Ingredient.Value> p_43939_) {
            MPGNBTIngredient ingredient = new MPGNBTIngredient(p_43939_);

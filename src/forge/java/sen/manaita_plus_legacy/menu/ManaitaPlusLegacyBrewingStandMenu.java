...
public class ManaitaPlusLegacyBrewingStandMenu extends AbstractContainerMenu {
    ...
    public ManaitaPlusLegacyBrewingStandMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        this(id, inv, new SimpleContainer(5), new SimpleContainerData(2));
    }

    public ManaitaPlusLegacyBrewingStandMenu(int p_39093_, Inventory p_39094_, Container p_39095_, ContainerData p_39096_) {
        super(ManaitaPlusLegacyMenuCore.BrewingStandManaita.get(), p_39093_);

...
public class ManaitaPlusLegacySourceItem extends Item {
    ...
    public void appendHoverText(@NotNull ItemStack stack, @Nullable Level level, @NotNull List<Component> tooltip, @NotNull TooltipFlag flag) {
        ...
        tooltip.add(Component.literal(ManaitaPlusText.manaita_infinity.formatting(I18n.get("info.source.1"))));
    }
        ...
        if (!level.isClientSide && player instanceof ServerPlayer serverPlayer) {
            NetworkHooks.openScreen(
                    ...
                    new SimpleMenuProvider(
                            (windowId, inventory, menuPlayer) -> new ManaitaPlusLegacyCraftingMenu(windowId, inventory, level),

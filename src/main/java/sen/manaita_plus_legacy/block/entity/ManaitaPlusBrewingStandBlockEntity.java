...
public class ManaitaPlusBrewingStandBlockEntity extends BaseContainerBlockEntity implements WorldlyContainer {
    ...
    private static void doBrew(Level p_155291_, BlockPos p_155292_, NonNullList<ItemStack> p_155293_) {
        ...
        ManaitaPlusLegacyBrewingLogicHelper.finishBrew(p_155291_, p_155292_.getX(), p_155292_.getY(), p_155292_.getZ(), p_155293_, 3);
    ...
    public boolean canPlaceItem(int p_59017_, @NotNull ItemStack p_59018_) {
        return ManaitaPlusLegacyBrewingLogicHelper.canPlaceItem(p_59017_, p_59018_, this.getItem(p_59017_));
    }
